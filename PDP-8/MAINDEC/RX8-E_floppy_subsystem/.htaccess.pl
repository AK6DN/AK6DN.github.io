...
my %db = (
    'DIRXA-C' => 'PDP-8 RX8E/RX01 RX28/RX02 Functional Test 1 rev C',
    'DIRXA-D' => 'PDP-8 RX8E/RX01 RX28/RX02 Functional Test 1 rev D',
    'DIRXB-D' => 'PDP-8 RX8E/RX01 RX28/RX02 Functional Test 2',
    );
